...
#define DHTPIN 4 // mendefiniskan pin dht di nodemcu adalah 4, D2 = 4
...
void setup() {
  ...
  Serial.begin(9600); 
  dht.begin(); // dht mulaimembaca suhu dan kelembapan
...
void loop() {
  ...
  if(millis()-last>10000){ // jika sudah 10 detik
     ...
     client.sendAll(true); // ubidots client mengirimkan semua datan
